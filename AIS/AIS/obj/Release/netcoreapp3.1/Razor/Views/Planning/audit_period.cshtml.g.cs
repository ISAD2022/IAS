#pragma checksum "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "94247d84808f319979361951556661bcb5b8308e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"94247d84808f319979361951556661bcb5b8308e", @"/Views/Planning/audit_period.cshtml")]
...
<script type=""text/javascript"">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, period) {
                        ...
                        $('#listOfAuditPeriods tbody').append('<tr id=teamcode_' +");
            WriteLiteral(@" period.auditperiodid + '><td class=""searchable""><p class=""fw-normal mb-1"">' + srNo + '</p></td><td class=""searchable""><p class=""fw-normal mb-1"">' + period.description + ' </p></td><td class=""searchable""><p class=""empName fw-normal mb-1"">' + period.starT_DATE + ' </p></td><td class=""searchable""><p class=""empName fw-normal mb-1"">' + period.enD_DATE + ' </p></td><td class=""searchable""><p class=""empName fw-normal mb-1"">' + status + ' </p></td><td><small onclick=""getAuditPlan(' + period.auditperiodid+')"" class=""text-danger planDetails"">Details</small></td></tr>');
                        srNo++;
                    });
    ...
    function setupNewAuditPeriod() {
        ...
        $.each($('.deptCheckBoxes'), function (index, chkbox) {
            if ($");
            WriteLiteral(@"(chkbox).is(':checked')) {
                $(chkbox).click();
            }
        });
    ...
    function publishNewAuditPeriodChanges() {
        ...
        var startDate = (""0"" + mm).slice(-2) + ""/"" + (""0"" + dd).sl");
            WriteLiteral(@"ice(-2) + ""/"" + yy;
    ...
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "94247d84808f319979361951556661bcb5b8308e9379", async() => {
                WriteLiteral(@"
...
#nullable restore
#line 163 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
...
#nullable disable
                WriteLiteral(@"                                    <div class=""form-group"">
                                        <div class=""row w-100 col-md-12"">
                                            <div class=""col-md-10"">
                                                <small");
                BeginWriteAttribute("for", " for=\"", 7443, "\"", 7468, 2);
                WriteAttributeValue("", 7449, "checkbox_", 7449, 9, true);
#nullable restore
#line 170 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
WriteAttributeValue("", 7458, item.CODE, 7458, 10, false);
...
#nullable disable
                ...
                BeginWriteAttribute("dept-id", " dept-id=\"", 7703, "\"", 7723, 1);
#nullable restore
#line 173 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
WriteAttributeValue("", 7713, item.CODE, 7713, 10, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("id", " id=\"", 7724, "\"", 7748, 2);
                WriteAttributeValue("", 7729, "checkbox_", 7729, 9, true);
#nullable restore
#line 173 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
WriteAttributeValue("", 7738, item.CODE, 7738, 10, false);
...
#nullable disable
                ...
                BeginWriteAttribute("value", " value=\"", 7770, "\"", 7788, 1);
#nullable restore
#line 173 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
WriteAttributeValue("", 7778, item.CODE, 7778, 10, false);
