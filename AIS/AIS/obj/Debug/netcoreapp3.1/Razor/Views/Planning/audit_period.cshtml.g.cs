#pragma checksum "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d4583d91a306bff19364d5f168b4835ec7bb938d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d4583d91a306bff19364d5f168b4835ec7bb938d", @"/Views/Planning/audit_period.cshtml")]
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, period) {
                        ...
                        $('#listOfAuditPeriods tbody').append('<tr id=teamcode_' + p");
            WriteLiteral(@"eriod.id + '><td class=""searchable""><p class=""fw-normal mb-1"">' + srNo + '</p></td><td class=""searchable""><p class=""fw-normal mb-1"">' + period.description + ' </p></td><td class=""searchable""><p class=""empName fw-normal mb-1"">' + period.starT_DATE + ' </p></td><td class=""searchable""><p class=""empName fw-normal mb-1"">' + period.enD_DATE + ' </p></td><td class=""searchable""><p class=""empName fw-normal mb-1"">' + status + ' </p></td><td><small onclick=""getAuditPlan(' + period.id+')"" class=""text-danger planDetails"">Details</small></td></tr>');
                        srNo++;
                    });
    ...
    <div class=""modal-dialog"" role=""d");
        ...
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d4583d91a306bff19364d5f168b4835ec7bb938d9270", async() => {
                WriteLiteral(@"
...
#nullable disable
                WriteLiteral(@"                                    <div class=""form-group"">
                                        <div class=""row w-100 col-md-12"">
                                            <div class=""col-md-10"">
                                                <small");
                BeginWriteAttribute("for", " for=\"", 7334, "\"", 7359, 2);
                WriteAttributeValue("", 7340, "checkbox_", 7340, 9, true);
#nullable restore
#line 167 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
WriteAttributeValue("", 7349, item.CODE, 7349, 10, false);
...
#nullable disable
                ...
                BeginWriteAttribute("dept-id", " dept-id=\"", 7594, "\"", 7614, 1);
#nullable restore
#line 170 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
WriteAttributeValue("", 7604, item.CODE, 7604, 10, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("id", " id=\"", 7615, "\"", 7639, 2);
                WriteAttributeValue("", 7620, "checkbox_", 7620, 9, true);
#nullable restore
#line 170 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
WriteAttributeValue("", 7629, item.CODE, 7629, 10, false);
...
#nullable restore
#line 170 "D:\Audit Inspection Sol\ais\AIS\AIS\Views\Planning\audit_period.cshtml"
WriteAttributeValue("", 7669, item.CODE, 7669, 10, false);
