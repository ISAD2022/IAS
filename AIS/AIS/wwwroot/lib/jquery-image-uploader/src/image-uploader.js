...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let createImg = function (src, id) {
            ...
            $button.on("click", function (e) {
                ...
                if ($container.data('index')) {
                    ...
                    g_dataTransfer.items.remove(index);
                    console.log('indexxxxx', index);

                    g_uploadedFileList.splice(index, 1,null);
                ...
                $input.prop('files', g_dataTransfer.files);
        ...
        let fileSelectHandler = function (e) {
            ...
            // Get the files
            let files = e.target.files || e.originalEvent.g_dataTransfer.files;
        ...
        let setPreview = function ($container, files) {
            console.log('previewwwww', files);          
            $.each(files, function (i, v) {
                g_uploadedFileList.push(v);
            });
            ...
            $(files).each(function (i, file) {
                ...
                g_dataTransfer.items.add(file);

                // Set preview
                $uploadedContainer.append(createImg(URL.createObjectURL(file), g_dataTransfer.items.length - 1));
