...
namespace AIS.Controllers
{
    public class DBConnection : Controller
    {
        ...
        public GetOldParasBranchComplianceTextModel GetOldParasBranchComplianceTextRef(string Ref_P, string PARA_CATEGORY, string REPLY_DATE, int OBS_ID)
        {
            sessionHandler = new SessionHandler();
            sessionHandler._httpCon = this._httpCon;
            sessionHandler._session = this._session;
        ...
        public GetOldParasBranchComplianceTextModel GetOldParasBranchComplianceTextForZone(string Ref_P, string PARA_CATEGORY, string REPLY_DATE, int OBS_ID)
        {
            sessionHandler = new SessionHandler();
            sessionHandler._httpCon = this._httpCon;
            sessionHandler._session = this._session;
        ...
        public GetOldParasBranchComplianceTextModel GetOldParasBranchComplianceTextForZoneRef(string Ref_P, string PARA_CATEGORY, string REPLY_DATE, int OBS_ID)
        {
            sessionHandler = new SessionHandler();
            sessionHandler._httpCon = this._httpCon;
            sessionHandler._session = this._session;
        ...
        public string AddOldParasBranchComplianceReply(string Para_ID, int AU_OBS_ID, string Para_Cat, string Reply, List<AuditeeResponseEvidenceModel> EVIDENCE_LIST)
        {
            int AUD_RESP_ID = 0;
            string resp = "";
            sessionHandler = new SessionHandler();
        ...
        public string AddOldParasStatusUpdate(string OBS_ID, string REFID, string REMARKS, int NEW_STATUS, string PARA_CATEGORY, string SETTLE_INDICATOR)
        {
            string resp = "";
            sessionHandler = new SessionHandler();
            sessionHandler._httpCon = this._httpCon;
        ...
        public string AddOldParasStatusPartiallySettle(string OBS_ID, string REFID, string REMARKS, int NEW_STATUS, string PARA_CATEGORY, string SETTLE_INDICATOR, List<ObservationResponsiblePPNOModel> RESPONSIBLES_ARR)
        {
            string resp = "";
            sessionHandler = new SessionHandler();
            sessionHandler._httpCon = this._httpCon;
        ...
        public string AddAuthorizeChangeStatusRequestForSettledPara(string REFID, int NEW_STATUS)
        ...
        public string GetEmployeeNameFromPPNO(int PP_NO)
        {
            string emp_name = "";
            sessionHandler = new SessionHandler();
            sessionHandler._httpCon = this._httpCon;
        ...
        public string GetComplianceHistoryCount(string REF_P, int OBS_ID =0)
        {
            string resp = "";
            var con = this.DatabaseConnection(); con.Open();
        ...
        public List<ComplianceHistoryModel> GetComplianceHistory(string REF_P, int OBS_ID = 0)
        {
            ...
            using (OracleCommand cmd = con.CreateCommand())
            {
                ...
                while (rdr.Read())
                {
                    ...
                    st.OBS_ID = Convert.ToInt32(rdr["AU_OBS_ID"].ToString());
